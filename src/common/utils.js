...
export function getImage(id) {
  ...
  switch (id) {
    case 800:
      return (img = `src/assets/Clear.png`);
      break;

    case 801:
      return (img = `src/assets/LightCloud.png`);
      break;

    case 802:
    case 803:
    case 804:
      return (img = `src/assets/HeavyCloud.png`);
      break;
    ...
    case 503:
    case 504:
      return (img = `src/assets/HeavyRain.png`);
      break;
    ...
    case 500:
    case 501:
      return (img = `src/assets/LightRain.png`);
      break;

    case 511:
      return (img = `src/assets/Sleet.png`);
      break;
    ...
    case 621:
    case 622:
      return (img = `src/assets/Snow.png`);
      break;
    ...
    case 231:
    case 232:
      return (img = `src/assets/Thunderstorm.png`);
      break;
    default:
      break;
  }
